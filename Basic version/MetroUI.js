var GridGenerator = (function () {
    function renderGrid(element, settings) {
        ...
        $(element).find('.grid').width(800 / x);
        $(element).find('.grid').height(800 / x);
    }
    ...
    function colorTiles(element, options) {
        $(element).find(".grid").css('backgroundColor', getOptions(options).backgroundColor);
    }
    ...
    jQuery.fn.tiles = function (options) {
